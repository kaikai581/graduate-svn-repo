#ifndef EVENT2DB_V041ALG_HPP
#define EVENT2DB_V041ALG_HPP
...
class Event2DB_v041Alg : public GaudiAlgorithm
{
public:
  /// Constructor has to be in this form
  Event2DB_v041Alg(const std::string&, ISvcLocator*);
  virtual ~Event2DB_v041Alg(){};
