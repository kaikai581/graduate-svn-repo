#ifndef EVENT2DB_V042ALG_HPP
#define EVENT2DB_V042ALG_HPP
...
class Event2DB_v042Alg : public GaudiAlgorithm
{
public:
  /// Constructor has to be in this form
  Event2DB_v042Alg(const std::string&, ISvcLocator*);
  virtual ~Event2DB_v042Alg(){};
