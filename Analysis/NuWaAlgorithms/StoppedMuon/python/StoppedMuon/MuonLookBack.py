...
# $ nuwa.py -A 1*s -n 100 -m"StoppedMuon.MuonLookBack -s20 -e1000" /global/project/projectdirs/dayabay/data/exp/dayabay/2011/p12e/Neutrino/1224/recon.Neutrino.0021221.Physics.EH1-Merged.P12E-P._0001.root
...
def configure(argv=[]):
  ...
  parser.add_option("-r","--radius", action = "store", type = "float", default = 1000, help = "the inscribing cylinder coaxial with the muon track")
  ...
  myAlg.TrackCylinderRadius = opts.radius
