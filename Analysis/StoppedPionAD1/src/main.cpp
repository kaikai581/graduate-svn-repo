/*
 * 
 * This program searches for stopped pions inside ADs.
 * Based on the discussions made in July 2, 2012,
 * a pion hits RPC and stopped in an AD.
 * Then it decays into a muon and a neutrino.
 * Then the muon stops and undergoes Michel process.
 * 
 */
