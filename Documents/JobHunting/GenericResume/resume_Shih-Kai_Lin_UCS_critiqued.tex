...
\section{Objective}
Looking for a full-time job title in company utilizing experience in programming, algorithm design and statistical analysis.
...
\begin{tabular}{rl}
\textsc{May} 2014 & Doctor of Philosophy in \textsc{Physics}, \textbf{University of Houston}, Houston, TX\\
...
\emph{\textsc{Jan 2009} - Current}\hspace{5 mm} & Research assistant at \textsc{University of Houston}, Houston, TX \\
& \small
\begin{itemize}
  ...
  \item Designed a reconstruction algorithm to reconstruct the incident position and the track of cosmic ray muons.
...
\begin{itemize}
  ...
  \item Implemented an algorithm utilizing Fast Fourier Transform spectra to reject near-threshold detector noise.
  \item Calibrated the Ge detector with $^{137}$Cs, $^{60}$Co, $^{55}$Fe, $^{32}$P.
\end{itemize}
\\
\multicolumn{2}{c}{} \\
