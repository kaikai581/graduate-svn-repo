...
public :
   ...
   MoreInfo(char *fn=0, TTree *tree=0);
   virtual ~MoreInfo();
...
#ifdef MoreInfo_cxx
MoreInfo::MoreInfo(char *fn, TTree *tree)
{
...
Int_t MoreInfo::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MoreInfo::LoadTree(Long64_t entry)
{
...
void MoreInfo::Show(Long64_t entry)
{
...
Int_t MoreInfo::Cut(Long64_t entry)
{
